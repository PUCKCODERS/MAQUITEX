...
const Factura = () => {
  ...
  return (
    <section className="w-full !p-4 md:!p-10 bg-[#f9f9f9] flex flex-col items-center justify-center gap-5">
      <style>
        {`
          @media print {
            @page {
      ...
      <div className="flex flex-col items-center gap-2 hide-on-print text-center px-4">
        <span className="font-bold text-[#274a72] text-[12px] md:text-[16px]">
        ...
        >
          <RiMailSendLine className="text-[16px] md:text-[18px]" /> ENVIAR
          PEDIDO
        </Button>
      </div>
    </section>
